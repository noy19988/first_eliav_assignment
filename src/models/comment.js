            ...
            validator: function (postId) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, mongoose_1.default.model('Post').findById(postId)];
                            case 1:
                                post = _a.sent();
                                return [2 /*return*/, post != null];
                        }
                    });
                });
            },
        ...
        validate: {
            validator: function (authorId) {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, mongoose_1.default.model('User').findById(authorId)];
                            case 1:
                                user = _a.sent();
